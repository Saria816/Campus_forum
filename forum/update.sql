...
-- If the reference_id table exists, rename it to related_id
...
-- If the notifications table does not exist, create it
...
-- If the notifications table exists but there is no content column, add it
...
-- If the notifications table exists but there is no related_id column, add it
...
-- Check whether the index exists and create it
...
-- If the "messages" table exists, check and update the column names
...
-- If the "messages" table exists but there is no "content" column, add it
...
-- Check whether the password_resets table exists
...
-- If the password_resets table does not exist, create it
...
-- If the table exists but there are no necessary columns, add them
...
-- Check and add the user's unique key
...
-- Check and add the "banned_until" column to the "users" table
SELECT COUNT(*) INTO @exists
FROM information_schema.columns 
WHERE table_schema = 'campus_forum' 
AND table_name = 'users' 
...
-- Check and add the "ban_reason" column to the "users" table
SELECT COUNT(*) INTO @exists
FROM information_schema.columns 
WHERE table_schema = 'campus_forum' 
AND table_name = 'users' 
...
-- Check and add the "banned_by" column to the "users" table
SELECT COUNT(*) INTO @exists
FROM information_schema.columns 
WHERE table_schema = 'campus_forum' 
AND table_name = 'users' 
...
-- Check and add the "banned_at" column to the "users" table
SELECT COUNT(*) INTO @exists
FROM information_schema.columns 
WHERE table_schema = 'campus_forum' 
AND table_name = 'users' 
...
-- Check and add the "responded_by" column to the "staff_messages" table
SELECT COUNT(*) INTO @exists
FROM information_schema.columns 
WHERE table_schema = 'campus_forum' 
...
-- Check and add the response column to the staff_messages table
SELECT COUNT(*) INTO @exists
FROM information_schema.columns 
WHERE table_schema = 'campus_forum' 
AND table_name = 'staff_messages' 
...
-- Check and add the "responded_at" column to the "staff_messages" table
SELECT COUNT(*) INTO @exists
FROM information_schema.columns 
WHERE table_schema = 'campus_forum' 
AND table_name = 'staff_messages' 
...
-- Check and add the department column to the staff_messages table
SELECT COUNT(*) INTO @exists
FROM information_schema.columns 
WHERE table_schema = 'campus_forum' 
AND table_name = 'staff_messages' 
...
-- Check and add the "priority" column to the "staff_messages" table
SELECT COUNT(*) INTO @exists
FROM information_schema.columns 
WHERE table_schema = 'campus_forum' 
AND table_name = 'staff_messages' 
...
-- Check and add the status column to the staff_messages table
SELECT COUNT(*) INTO @exists
FROM information_schema.columns 
WHERE table_schema = 'campus_forum' 
AND table_name = 'staff_messages' 
...
-- Check and add the added_by column to the sensitive_words table
SELECT COUNT(*) INTO @exists
FROM information_schema.columns 
WHERE table_schema = 'campus_forum' 
...
-- Check and add the added_at column to the sensitive_words table
SELECT COUNT(*) INTO @exists
FROM information_schema.columns 
WHERE table_schema = 'campus_forum' 
AND table_name = 'sensitive_words' 
...
-- Check and add the "is_active" column to the "sensitive_words" table
SELECT COUNT(*) INTO @exists
FROM information_schema.columns 
WHERE table_schema = 'campus_forum' 
AND table_name = 'sensitive_words' 
...
-- Check and add the "created_at" column to the "sensitive_words" table
SELECT COUNT(*) INTO @exists
FROM information_schema.columns 
WHERE table_schema = 'campus_forum' 
AND table_name = 'sensitive_words' 
...
-- Check and add the "updated_at" column to the "sensitive_words" table
SELECT COUNT(*) INTO @exists
FROM information_schema.columns 
WHERE table_schema = 'campus_forum' 
AND table_name = 'sensitive_words' 
